...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GoCoinMe server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "GoCoinMe server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GoCoinMe features */
        {"gocoinme", "masternode", &masternode, true, true, false},
        {"gocoinme", "listmasternodes", &listmasternodes, true, true, false},
        {"gocoinme", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gocoinme", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gocoinme", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gocoinme", "masternodedebug", &masternodedebug, true, true, false},
        {"gocoinme", "startmasternode", &startmasternode, true, true, false},
        {"gocoinme", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gocoinme", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gocoinme", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gocoinme", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gocoinme", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gocoinme", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gocoinme", "mnbudget", &mnbudget, true, true, false},
        {"gocoinme", "preparebudget", &preparebudget, true, true, false},
        {"gocoinme", "submitbudget", &submitbudget, true, true, false},
        {"gocoinme", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gocoinme", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gocoinme", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gocoinme", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gocoinme", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gocoinme", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gocoinme", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gocoinme", "checkbudgets", &checkbudgets, true, true, false},
        {"gocoinme", "mnsync", &mnsync, true, true, false},
        {"gocoinme", "spork", &spork, true, true, false},
        {"gocoinme", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gocoinme", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> gocoinme-cli " + methodname + " " + args + "\n";
}
