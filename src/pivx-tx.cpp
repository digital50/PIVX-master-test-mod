...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GoCoinMe Core gocoinme-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gocoinme-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gocoinme transaction") + "\n" +
                               "  gocoinme-tx [options] -create [commands]   " + _("Create hex-encoded gocoinme transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gocoinme transaction
