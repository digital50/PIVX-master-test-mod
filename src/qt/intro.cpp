...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GoCoinMe Core"),
     ...
     * override -datadir in the gocoinme.conf file in the default data directory
     * (to be consistent with gocoinmed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
