...
/* GoCoinMe GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GoCoinMe"
#define QAPP_ORG_DOMAIN "gocoinme.org"
#define QAPP_APP_NAME_DEFAULT "GoCoinMe-Qt"
#define QAPP_APP_NAME_TESTNET "GoCoinMe-Qt-testnet"
