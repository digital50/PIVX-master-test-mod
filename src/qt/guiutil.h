...
/** Utility functions used by the GoCoinMe Qt UI.
 */
namespace GUIUtil
{
...
// Render GoCoinMe addresses in monospace font
...
// Parse "gocoinme:" URI into recipient object, return true on successful parsing
