                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GoCoinMe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GoCoinMe address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gocoinme: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GoCoinMe Core"), this);
    aboutAction->setStatusTip(tr("Show information about GoCoinMe Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoCoinMe"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GoCoinMe addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GoCoinMe addresses"));
    ...
    openAction->setStatusTip(tr("Open a GoCoinMe: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoCoinMe Core help message to get a list with possible GoCoinMe command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GoCoinMe Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoCoinMe network", "", count));
}
...
{
    QString strTitle = tr("GoCoinMe Core"); // default title
