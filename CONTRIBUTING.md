Contributing to GoCoinMe Core
============================

The GoCoinMe Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GoCoinMe Core project, and is not to be
confused with overall GoCoinMe Network Protocol consensus changes.

Whether a pull request is merged into GoCoinMe Core rests with the project merge
...
Patches that change GoCoinMe consensus rules are considerably more involved than
...
Where a patch set proposes to change the GoCoinMe consensus, it must have been
...
The project leader is the release manager for each GoCoinMe Core release.
