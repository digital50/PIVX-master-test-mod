...
In order to support loading of multiple wallets in gocoinme-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gocoinme.cpp.
...
Changes to gocoinme.cpp
----------------------
gocoinme.cpp is the entry point into gocoinme-qt, and as such, will require some minor modifications to provide hooks for
