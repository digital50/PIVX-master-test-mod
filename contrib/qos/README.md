...
This means one can have an always-on gocoinmed instance running, and another local gocoinmed/gocoinme-qt instance which connects to this node and receives blocks from it.
