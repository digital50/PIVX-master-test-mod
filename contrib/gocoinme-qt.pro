...
RESOURCES += src/qt/gocoinme.qrc src/qt/gocoinme_locale.qrc

TRANSLATIONS += src/qt/locale/gocoinme_bg.ts \
                src/qt/locale/gocoinme_de.ts \
                src/qt/locale/gocoinme_en.ts \
                src/qt/locale/gocoinme_es.ts \
                src/qt/locale/gocoinme_fi.ts \
                src/qt/locale/gocoinme_fr.ts \
                src/qt/locale/gocoinme_it.ts \
                src/qt/locale/gocoinme_ja.ts \
                src/qt/locale/gocoinme_pl.ts \
                src/qt/locale/gocoinme_pt.ts \
                src/qt/locale/gocoinme_ru.ts \
                src/qt/locale/gocoinme_sk.ts \
                src/qt/locale/gocoinme_sv.ts \
                src/qt/locale/gocoinme_vi.ts \
                src/qt/locale/gocoinme_zh_CN.ts \
                src/qt/locale/gocoinme_zh_TW.ts
